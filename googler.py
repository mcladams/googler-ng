...
API_REPO_BASE = 'https://api.github.com/repos/grassdionera/googler'
...
class GoogleParser(object):
    ...
    def parse(self, html):
        ...
        if self.news:
            div_selector = 'div.W0kfrc'
            title_selector = 'div'
            h3_selector = 'div.n0jPhd'
        elif self.videos:
            div_selector = 'video-voyager'
            title_selector = 'div.ct3b9e'
            h3_selector = 'h3'
        else:
            div_selector = 'div.MjjYud'
            title_selector = 'div.yuRUbf'
            h3_selector = 'h3'
